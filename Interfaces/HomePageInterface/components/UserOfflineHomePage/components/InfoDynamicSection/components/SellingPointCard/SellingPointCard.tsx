import { SellingPointCardProps } from "@/Interfaces/HomePageInterface/types";
...
const SellingPointCard = ({
  ...
  return (
    <div
      ...
      hover:-translate-y-2 
      hover:shadow-[0_0_20px_rgba(132,233,228,0.35)]"
    >
      <div className="mb-4 text-4xl text-amber-500 drop-shadow-lg">{icon}</div>

      <h3 className="mb-2 text-2xl font-semibold text-amber-500 text-center">
        {title}
      </h3>
