...
import {
  TenantModesProps,
  TenantWithSeason,
} from "@/Interfaces/HomePageInterface/types";

const FeaturedTenantCard = ({ tenant }: { tenant: TenantWithSeason }) => {
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <SubscriptionBadge
          subscription={tenant.subscriptionMode as TenantModesProps}
        />
        <div>
        ...
        <div>
          <span className="text-gray-500">
            Giros Totais: {tenant.stats?.totalSpins}
          </span>
        </div>
      ...
      <div className="md:text-base text-gray-500 flex flex-col">
