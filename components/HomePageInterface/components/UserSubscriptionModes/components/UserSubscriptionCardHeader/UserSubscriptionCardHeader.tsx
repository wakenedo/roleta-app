import { UserPlansProps } from "@/components/HomePageInterface/types";

const UserSubscriptionCardHeader = ({ plan }: UserPlansProps) => {
  return (
    <>
...
export default UserSubscriptionCardHeader;
